...
MODULE_2_5_FOLDERS: dict[str, str] = {
    ...
    # P22: the tabular listing of all clinical studies. Generated by
    # walking the studies actually filed under 5.3.1, which is what stops
    # it from being the summary table that disagrees with the reports
    # beneath it -- the single most common defect in a Module 5.
    "5.2": "m5/52-tabular-listing-of-all-clinical-studies",
